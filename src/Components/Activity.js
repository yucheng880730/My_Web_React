    ...
    events: [
      {
        ...
        title: "AWS For Girls",
        content:
          "Official event organized by AWS, the workshop is about building a CI / CD pipeline for a personal website. In this workshop, we use several Amazon Web Service such as S3, IAM, CodePipeline and SNS. As an assistant, I gave lots of guidance for more than 5 people to finish their project during the workshop.",
        img: "../../images/event/AWSGirlsDay.jpg",
      },
      {
        id: "2",
        title: "IBM Hackathon",
        content:
          "This is a course which cooperated with IBM. In this course, different consultants taught us variety contents, container or Devops concepts for instance and even the process of CI / CD  . With all of these, I understand more deeply about the techniques that the industry uses in practical. At the final hackathon each team need to use technology to address pain points in lives, We proposed a questionnaire system and finally won the second place.",
        img: "../../images/event/IBM.jpg",
      },
      {
        id: "3",
